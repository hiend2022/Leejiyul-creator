...
"""
Tag의 종류 : 
Okt, twitter, Hannaum, KKma, Komoran 

형태소? tagging 
"""

print(okt.nouns(raw_text))
noun = okt.nouns(raw_text)
count = Counter(noun)

#가장 많이 등장한 단어를 100개 이내로 알려줌.
noun_list = count.most_common(10)

for freq_noun in noun_list:
    print(freq_noun)

with open('noun_list.text', 'w', encoding='utf-8') as f:
    for freq_noun in noun_list: 
        f.write("". join(map(str, freq_noun)))
        #join_ 뭉쳐주는 코드
        f.write("\n")
#파일 이름, w=wirte
